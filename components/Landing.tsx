...
export default function Landing() {
    return (
        <div className="p-12 text-black flex flex-col justify-center items-center">
            <h1 className="text-3xl font-bold mb-4">Hi there!</h1>
            <img src="./portrait.png" className="rounded-full shadow-md mb-4" alt="Picture of me" />
            ...
            <div id="links" className="flex flex-col sm:flex-row text-xl">
                <a className="hover:text-purple-600" target="blank">
